                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    switch (task.getException().toString()) {
                                        ...
                                        case "auth/weak-password":
                                            ...
                                            Toast.makeText(SignUp.this, "Password should be 8 characters or longer", Toast.LENGTH_SHORT).show();

                                        default:
                                            //PasswordWarning.setText("Error during sign up");
                                            Toast.makeText(SignUp.this, "Error during sign up", Toast.LENGTH_SHORT).show();
